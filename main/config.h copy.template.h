...
#define WIFI_RECONNECT_ATTEMPTS 2                // Immediate reconnect attempts after disconnect
#define WIFI_DISCONNECT_GRACE_SEC 5             // Seconds to wait before sleep after disconnect
...
#define BATTERY_CRITICAL_THRESHOLD 3.4f         // Voltage for "critical" state
...
#define NRF52_POWER_OFF_SEC 43200                // Keep off for 12 hours (43200 sec)
                                                 // Testing: use 60 for 1 minute
